  ...
  return (
    <div className="space-y-6">
      ...
      <div className="mb-8">
        ...
        <Text type="secondary">
          Welcome to the Taant Supplier Panel. Here's what's happening with your account.
        </Text>
      </div>
              ...
              {users.slice(0, 5).map((user) => (
                <div key={user.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  ...
                  <div className="text-right">
                    <div>
                      <Tag color={user.profile?.role === 'supplier' ? 'green' :
                                user.profile?.role === 'customer' ? 'blue' : 'orange'}>
