      ...
      <div className="bg-white py-2">
        <div className="container px-2 sm:px-3 md:px-4">
          ...
          <div className="flex lg:hidden flex-col gap-3">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3 sm:gap-6">
                <button
                  onClick={() => isAuthenticated ? logout() : showAuthModal('signin')}
            ...
            <div className="relative">
              <div className="flex items-center border border-gray-300 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="relative">
                  ...
                  {isCategoryDropdownOpen && (
                    <div className="absolute top-full left-0 w-48 sm:w-56 bg-white border border-gray-200 rounded-lg shadow-xl z-50 mt-1">
                      <div className="py-2 max-h-60 overflow-y-auto">
                        {categories.map((category) => (
                          <button
                            ...
                            className="w-full flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 hover:bg-gray-50 transition-colors text-left"
                          >
                ...
                <button className="px-3 sm:px-7 py-2 sm:py-3 bg-orange-500 hover:bg-orange-600 text-white font-medium transition-all duration-200 rounded-r-lg">
              ...
              {/* Search Suggestions */}
              {searchQuery && (
                <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-gray-200 rounded-lg shadow-xl z-40">
                  <div className="p-3 sm:p-4">
                    <div className="text-sm text-gray-500 mb-2">Popular suggestions</div>
                    <div className="space-y-2">
                      <div className="text-sm text-gray-700 hover:text-orange-600 cursor-pointer">iPhone 15 Pro Max</div>
                      <div className="text-sm text-gray-700 hover:text-orange-600 cursor-pointer">Nike Air Max</div>
                      <div className="text-sm text-gray-700 hover:text-orange-600 cursor-pointer">Sony Headphones</div>
                    </div>
                  </div>
                </div>
              )}
          ...
          <div className="hidden lg:flex items-center gap-6 lg:gap-8">
            ...
            <div className="flex-1 min-w-0 max-w-3xl xl:max-w-5xl">
              <div className="relative">
                <div className="flex items-center border border-gray-300 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                  {/* Category Dropdown */}
                  <div className="relative">
                    ...
                    {/* Category Dropdown Menu */}
                    {isCategoryDropdownOpen && (
                      <div className="absolute top-full left-0 w-56 bg-white border border-gray-200 rounded-lg shadow-xl z-50 mt-1">
                        <div className="py-2">
                          {categories.map((category) => (
                            <button
                              key={category.id}
                  ...
                  {/* Search Button */}
                  <button className="px-7 py-3 bg-orange-500 hover:bg-orange-600 text-white font-medium transition-all duration-200 rounded-r-lg">
